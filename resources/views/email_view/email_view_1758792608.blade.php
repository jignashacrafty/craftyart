...
<head>
    ...
    <style>
        ...
        .header {
            background: linear-gradient(180deg, #9BAAEC, #FDFDFF);
            padding: 35px 20px;
            text-align: center;
        }
    ...
    <div class="container">
        ...
        @if ($data['type'] == 'template')
            ...
            @if (!empty($data['data']['amount']) && count($data['data']['templates']) > 1)
                <div class="content">
                    <p>
                        Complete your order now for
                        <strong>just {{ $data['data']['amount'] }}</strong>
                    </p>
            ...
            @else
                ...
                <div class="single-template">
                    ...
                    <div class="text-block">
                        ...
                        <ul>
                            <li>✔ Watermark-free export of this design</li>
                            <li>✔ No subscription required</li>
                            <li>✔ Available Formats ( PDF, PNG, JPG and MP4 )</li>
                        </ul>
                    </div>
                </div>
            @endif
        ...
        <div class="content">
            ...
            @if ($data['type'] == 'plan' && !empty($data['data']['actual_price']) && !empty($data['data']['price']))
                <p class="offer">
                    Complete your order now for
                    <strong>just {{ $data['data']['price'] }} (originally
