                        ...
                        @forelse($applications as $application)
                                ...
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    @if($application->experience_level)
                                                        <p><strong>Experience Level:</strong> {{ ucfirst(str_replace('-', ' ', $application->experience_level)) }}</p>
                                                    @endif
                                            ...
                                            @if($application->status != 'pending')
                                                <hr>
                                                <p><strong>Reviewed By:</strong> {{ $application->reviewer ? $application->reviewer->name : 'N/A' }}</p>
                                                <p><strong>Reviewed At:</strong> {{ $application->reviewed_at ? $application->reviewed_at->format('d M Y H:i') : 'N/A' }}</p>
                            ...
                            <div class="modal fade" id="approveModal{{ $application->id }}" tabindex="-1" role="dialog">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <form method="POST" action="{{ route('designer_system.application.approve', $application->id) }}">
                                            @csrf
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                <p>Are you sure you want to approve <strong>{{ $application->name }}</strong>'s application?</p>
                                                <p class="text-info">This will create a designer account with login credentials.</p>
                            ...
                            <div class="modal fade" id="rejectModal{{ $application->id }}" tabindex="-1" role="dialog">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <form method="POST" action="{{ route('designer_system.application.reject', $application->id) }}">
                                            @csrf
                                            <div class="modal-header">
