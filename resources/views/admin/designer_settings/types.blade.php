    ...
    <div class="designer-system-container">
        ...
        <div class="system-card">
            <div class="system-header">
                <div>
                    <h1 class="system-title">Designer Types</h1>
                    <p class="system-subtitle">Manage what designers create (Social Media, Print, Video, etc.)</p>
                </div>
                ...
                <table class="system-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <button class="btn-action btn-edit" onclick="openEditModal({{ $type->id }}, '{{ addslashes($type->name) }}', '{{ addslashes($type->description) }}', '{{ $type->icon }}', {{ $type->sort_order }})">
                                <i class="fa fa-edit"></i>
                            </button>
                            <form action="{{ route('designer_system.types.toggle', $type->id) }}" 
                                  method="POST" style="display:inline;">
                                @csrf
                                <button type="submit" class="btn-action btn-toggle">
                                    <i class="fa fa-toggle-{{ $type->is_active ? 'on' : 'off' }}"></i>
                                </button>
                            </form>
                            <form action="{{ route('designer_system.types.delete', $type->id) }}" 
                                  method="POST" style="display:inline;" 
...
<div id="addModal" class="modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('designer_system.types.store') }}" method="POST">
                @csrf
...
function openEditModal(id, name, description, icon, sortOrder) {
    ...
    document.getElementById('editForm').action = '{{ url("designer-system/types") }}/' + id;
