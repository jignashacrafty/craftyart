        ...
        <div class="system-card">
            <div class="system-header">
                <div>
                    ...
                    <p class="system-subtitle">Manage designer motivations and goals</p>
                </div>
                ...
                <table class="system-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <button class="btn-action btn-edit" onclick="openEditModal({{ $goal->id }}, '{{ addslashes($goal->name) }}', '{{ addslashes($goal->description) }}', '{{ $goal->icon }}', {{ $goal->sort_order }})">
                                <i class="fa fa-edit"></i>
                            </button>
                            <form action="{{ route('designer_system.goals.toggle', $goal->id) }}" 
                                  method="POST" style="display:inline;">
                                @csrf
                                <button type="submit" class="btn-action btn-toggle">
                                    <i class="fa fa-toggle-{{ $goal->is_active ? 'on' : 'off' }}"></i>
                                </button>
                            </form>
                            <form action="{{ route('designer_system.goals.delete', $goal->id) }}" 
                                  method="POST" style="display:inline;" 
