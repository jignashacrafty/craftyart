            ...
            <form id="paymentRequestForm">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="upi_id" value="vrajsurani606@okaxis" required
                            placeholder="yourname@okaxis">
                    </div>

                    <div class="form-group">
                        <label>Amount (₹) *</label>
                        <input type="number" class="form-control" name="amount" value="1" min="1" max="1000" required
                            placeholder="Enter amount">
                    </div>

                    <div class="form-group">
                        <label>Mobile Number *</label>
                        <input type="text" class="form-control" name="mobile" value="9724085965" required
            ...
            success: function (response) {
                if (response.success && response.data.length > 0) {
                    ...
                    response.data.forEach(function (item) {
                        ...
                        html += '<td class="text-center"><span class="status-badge ' + statusClass + '">' + (displayState || 'PENDING') + '</span></td>';
