                    ...
                    <div class="row justify-content-between">
                        <div class="col-md-3 m-1">
                            @if ($roleManager::isAdminOrSeoManager(Auth::user()->user_type) || $roleManager::isSeoExecutive(Auth::user()->user_type))
                                <a class="btn btn-primary item-form-input" href="create_new_cat" role="button"> Add New
                                    Category
                                </a>
                            @endif
                        </div>
                                ...
                                @foreach ($catArray as $cat)
                                    <tr>
                                        ...
                                        <td style="position: relative;">
                                            <label>{{ $helperController::getParentNewCatName($cat->parent_category_id, true) }}</label>
                                        </td>
                                        <td>{{ $cat->id_name }}</td>
                                        <td>
