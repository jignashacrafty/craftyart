    ...
    <div class="menu-block customscroll">
        <div class="sidebar-menu">
            <ul id="accordion-menu">
                ...
                <li class="dropdown {{ in_array(Route::currentRouteName(), ['phonepe.dashboard', 'phonepe.transactions.index', 'phonepe.transactions.show', 'phonepe.notifications.index', 'phonepe.notifications.show']) ? 'show' : '' }}">
                    <a href="javascript:;" class="dropdown-toggle">
                        <span class="micon">
                    ...
                    <ul class="submenu" style="display: {{ in_array(Route::currentRouteName(), ['phonepe.dashboard', 'phonepe.transactions.index', 'phonepe.transactions.show', 'phonepe.notifications.index', 'phonepe.notifications.show']) ? 'block' : 'none' }};">
                        <li>
