            ...
            <ul id="accordion-menu">
                                        ...
                                        : '' }}">
                                                        <a href="javascript:;" class="dropdown-toggle">
                                                            <span class="micon"><img
                                                                    src="{{ asset('assets/vendors/images/menu_icon/Template.svg') }}" alt=""></span>
                                                    ...
                                                    <li>
                                                        <a href="{{ route('raw_datas.index') }}"
                                                            ...
                                                            <span class="micon"><img
                                                                    src="{{ asset('assets/vendors/images/menu_icon/RawData.svg') }}" alt=""></span>
                                                    ...
                                                    <li
                                                        ...
                                                        <a href="javascript:;" class="dropdown-toggle">
                                                            <span class="micon"><img src="{{ asset('assets/vendors/images/menu_icon/Fonts.svg') }}"
                ...
                @if ($roleManager::isAdmin(Auth::user()->user_type))
                                ...
                                <li
                                    ...
                                    <a href="javascript:;" class="dropdown-toggle">
                                        <span class="micon"><img src="{{ asset('assets/vendors/images/menu_icon/SubscribeOld.svg') }}"
                        ...
                        : '' }}">
                                    ...
                                    <ul class="submenu child" style="display: {{ in_array(Route::currentRouteName(), [
                        'categoryFeatures.index',
                        'features.index',
                        'planduration.index',
                        'plans.index',
                ...
                @if ($roleManager::isAdmin(Auth::user()->user_type))
                        ...
                        'automation_report.index'
                                        ...
                                        <li
                                            class="dropdown {{ in_array(Route::currentRouteName(), ['campaign.index', 'campaign.report']) ? 'show' : '' }}">
                                            <a href="javascript:;" class="dropdown-toggle">Campaign</a>
                                            <ul class="submenu"
                                                style="display: {{ in_array(Route::currentRouteName(), ['campaign.index', 'campaign.report']) ? 'block' : 'none' }};">
                                        ...
                                        <li
                                            class="dropdown {{ in_array(Route::currentRouteName(), ['automation_config.index', 'automation_report.index']) ? 'show' : '' }}">
                ...
                @if ($roleManager::salesHierarchyAccess(Auth::user()->user_type))
                    <li>
                        <a href="{{ route('order_user.index') }}"
                            ...
                            <span class="micon"><img src="{{ asset('assets/vendors/images/menu_icon/Notifications.svg') }}"
                    ...
                    @if($roleManager::isAdminOrSalesManager(Auth::user()->user_type))
                        <li>
                            <a href="{{ route('show_messages') }}"
                                ...
                                <span class="micon"><img src="{{ asset('assets/vendors/images/menu_icon/AppMessage.svg') }}"
                        ...
                        <li>
                            <a href="{{ route('show_feedbacks') }}"
                                ...
                                <span class="micon"><img src="{{ asset('assets/vendors/images/menu_icon/Feedback.svg') }}"
                        ...
                        <li>
                            <a href="{{ route('business_support_purchases') }}"
                                class="dropdown-toggle no-arrow {{ Route::currentRouteName() == 'business_support_purchases' ? 'selectSubMenu' : '' }}">
                                <span class="micon bi bi-calendar4-week"></span><span class="mtext">Business Support</span>
                            </a>
                        </li>
                    @endif
                @endif
