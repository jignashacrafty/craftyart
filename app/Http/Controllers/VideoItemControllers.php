...
class VideoItemControllers extends AppBaseController
{
    public function index(Request $request): Factory|View|Application
    {
        ...
        $videoItems = $this->applyFiltersAndPagination(
            $request,
            VideoItem::with('VideoCategory'),
            $searchableFields
            ,
            [
                'parent_query' => VideoCategory::query(),
                'related_column' => 'name',
                'column_value' => 'video_category_id',
            ]
        );
