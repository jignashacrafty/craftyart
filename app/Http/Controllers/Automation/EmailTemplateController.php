...
class EmailTemplateController extends AppBaseController
{
    ...
    public function preview($id): View|Factory|Response|Application|ResponseFactory
    {
    ...
    public function report(Request $request): Factory|View|Application
    {
        $searchableFields = [
            ...
            ["id" => 'email_sent', "value" => 'Sent'],
            ["id" => 'email_failed', "value" => 'Failed'],
        ...
        $logs = $this->applyFiltersAndPagination(
            $request,
            CampaignSendLog::query()->whereType(AutomationType::EMAIL)->orWhere("type",AutomationType::EMAIL_WHATSAPP),
            $searchableFields
        );
