<?php
// app/Models/AutomationSendLog.php
 ...
 * @property-read Collection<int, \App\Models\AutomationSendDetail> $details
 * @property-read int|null $details_count
 * @property-read Collection<int, \App\Models\AutomationSendDetail> $emailDetails
 * @property-read int|null $email_details_count
 * @property-read float $success_rate
 * @property-read Collection<int, \App\Models\AutomationSendDetail> $whatsappDetails
...
class AutomationSendLog extends Model
{
    ...
    public function whatsappDetails()
    {
        return $this->hasMany(AutomationSendDetail::class, 'log_id')
