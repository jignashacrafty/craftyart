...
class CryptoJsAes
{
     ...
     * @return string
     */
    public static function encrypt(mixed $value, string $passphrase = "E@7r1K7!6v#KZx^m"): string
    {
        ...
        $data = ["c" => base64_encode($encrypted_data), "i" => bin2hex($iv), "s" => bin2hex($salt)];
        return json_encode($data);
    }

    /**
     * Decrypt a previously encrypted value
     * @param mixed $jsonStr Json stringified value
     * @param string $passphrase Your password
     * @return mixed
     */
    public static function decrypt(mixed $jsonStr, string $passphrase = "E@7r1K7!6v#KZx^m"): mixed
    {
