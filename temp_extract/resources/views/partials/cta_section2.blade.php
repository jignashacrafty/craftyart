  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body" style="max-height: 80vh; overflow-y: auto;">
        ...
        <div class="form-group">
          <h7>Description</h7>
          <div style="height: 120px" class="input-group custom">
            <textarea style="height: 120px" class="form-control" id="ctaHelpDesc"></textarea>
          </div>
        </div>
...
<script type="text/javascript">
  ...
  var selectedID = null;
  var storageUrl = "{{config('filesystems.storage_url')}}";
  ...
  function onHelpSubmit(ctaName, ctaValue, modalKeyName) {
    ...
    var ctaHelpDesc = $('textarea#ctaHelpDesc').val();
    var ctaHelpInfo = $('#ctaHelpInfo').val();
    if (!ctaHelpTitle.trim() || !ctaHelpDesc.trim() || !ctaHelpInfo.trim()) {
  ...
  function resetScrollableCTAModal() {
    ...
    // $('#scrollableVirtualContainer #generatedQuery').val('')
    // const columnSelects = scrollableVirtualContainer.querySelector('#column');
    // columnSelects.selectedIndex = 0;
    // columnSelects.dispatchEvent(new Event('change'));
    // $('#scrollableVirtualContainer #conditionsTable tbody').empty();
  ...
  function resetHelpCTAModal() {
    ...
    $('textarea#ctaHelpDesc').css('height', '120px');
    $('#ctaHelpTitle').val('');
    $('textarea#ctaHelpDesc').val('');
    $('#ctaHelpInfo').val('');
    resetBgPara("Help");
    $(".closeMainCTAModal").click()
  }
