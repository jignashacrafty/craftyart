                    ...
                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-9">
                                <div class="pt-20">
                                    <form action="{{ route('active.subscriber.list') }}" method="GET">
                        ...
                        <div class="card-container">
                            ...
                            <a class="card active" href="{{ route('active.subscriber.list') }}"
                        ...
                        <section id="allActiveSubscriberList" style="display:block;">
