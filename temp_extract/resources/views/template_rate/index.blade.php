 ...
 @include('layouts.masterhead')
                    ...
                    <div class="row justify-content-between p-3">
                        ...
                        <div class="col-md-7">
                            @include('partials.filter_form', [
                                'action' => route('templateRate.index'),
                            ])
                        </div>
                    </div>
                </div>
                                ...
                                <div class="d-flex flex-wrap align-items-center">
                                    <div class="widget-data w-100">
                                        <div class="weight-600 font-15 text-center">
                                            Name : <span class="text-secondary fw-bold">{{ ucwords(str_replace('_', ' ', $rate->name)) }}</span>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-6">
                                                <hr>
                                                ...
                                                <div class="details text-left mt-3"  style="font-size:15px;">
                                                    <p>Base Price : <span
                                                            class="text-secondary fw-bold">₹ {{ $value['inr']['base_price'] ?? '-' }}</span>
                                                    </p>
                                                    <p>Page Price : <span
                                                            class="text-secondary fw-bold">₹ {{ $value['inr']['page_price'] ?? '-' }}</span>
                                                    </p>
                                                    <p>Max Price : <span
                                                            class="text-secondary fw-bold">₹ {{ $value['inr']['max_price'] ?? '-' }}</span>
                                                    </p>
                                                    <p>Editor's choice : <span
                                                            class="text-secondary fw-bold">₹ {{ $value['inr']['editor_choice'] ?? '-' }}</span>
                                                    </p>
                                                    <p>Animation : <span
                                                            class="text-secondary fw-bold">₹ {{ $value['inr']['animation'] ?? '-' }}</span>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <hr>
                                                ...
                                                <div class="details text-left mt-3"  style="font-size:15px;">
                                                    <p>Base Price : <span
                                                            class="text-secondary fw-bold">$ {{ $value['usd']['base_price'] ?? '-' }}</span>
                                                    </p>
                                                    <p>Page Price : <span
                                                            class="text-secondary fw-bold">$ {{ $value['usd']['page_price'] ?? '-' }}</span>
                                                    </p>
                                                    <p>Max Price : <span
                                                            class="text-secondary fw-bold">$ {{ $value['usd']['max_price'] ?? '-' }}</span>
                                                    </p>
                                                    <p>Editor's choice : <span
                                                            class="text-secondary fw-bold">$ {{ $value['usd']['editor_choice'] ?? '-' }}</span>
                                                    </p>
                                                    <p>Animation : <span
                                                            class="text-secondary fw-bold">$ {{ $value['usd']['animation'] ?? '-' }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="action d-flex text-right gap-2">
                                        <button class="dropdown-item edit-template-rate-btn"
                                            data-id="{{ $rate->id }}">
    ...
    <div class="modal fade" id="add_Template_Rate_model" tabindex="-1" role="dialog"
                ...
                <div class="modal-body">
                    <form id="templateRateForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <label class="text-secondary">Page Price</label>
                                    <input type="number" min="0" class="form-control" id="inrPage" name="inr_page"
                                        placeholder="Enter value" required>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" class="form-control" id="inrEditorChoice" name="editor_choice"
                                        placeholder="Enter value" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" class="form-control" id="inrAnimation" name="animation"
                                        placeholder="Enter value" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <label class="text-secondary">Base Price</label>
                                    <input type="number" min="0" step="0.01" class="form-control" id="usdBase" name="usd_base"
                                        placeholder="Enter value" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <label class="text-secondary">Page Price</label>
                                    <input type="number" min="0" step="0.01" class="form-control" id="usdPage" name="usd_page"
                                        placeholder="Enter value" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <label class="text-secondary">Max Price</label>
                                    <input type="number" min="0" step="0.01" class="form-control" id="usdMax" name="usd_max"
                                        placeholder="Enter value" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label class="text-secondary">Editor's choice</label>
                                    <input type="number" min="0" step="0.01" class="form-control" id="usdEditorChoice" name="editor_choice"
                                        placeholder="Enter value" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                <label class="text-secondary">Animation</label>
                                    <input type="number" min="0" step="0.01" class="form-control" id="usdAnimation" name="animation"
                                        placeholder="Enter value" required>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#addNewTemplateRate').on('click', function() {
                ...
                $('#templateRateId').val('');
                $('#add_Template_Rate_model .modal-title').text('Add Template Rate');
                $('#add_Template_Rate_model').modal('show');
            });
            ...
            $(document).on('click', '.edit-template-rate-btn', function() {
                ...
                $.get(`{{ url('templateRate') }}/${id}/edit`, function(response) {
                    if (response) {
                        ...
                        $('#inrPage').val(value.inr?.page_price || '');
            ...
            $('#templateRateForm').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        location.reload();
                        $('#add_Template_Rate_model').modal('hide');
                        $('#templateRateForm')[0].reset();
                    },
                    error: function(err) {
