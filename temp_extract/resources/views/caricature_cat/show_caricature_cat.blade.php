                ...
                <div style="display: flex; flex-direction: column; height: 90vh; overflow: hidden;">
                    <div class="row justify-content-between">
                        <div class="col-md-3 m-1">
                            ...
                            <a class="btn btn-primary item-form-input" href="create_cari_cat" role="button"> Add Category
                            </a>
                            @endif
                        </div>
                    ...
                    <div class="scroll-wrapper table-responsive tableFixHead"
                        ...
                        <table id="temp_table" style="table-layout: fixed; width: 100%;"
                            ...
                            <tr>
                                ...
                                <td><a target="_blank"
                                       href="show_item?new_cat={{ $cat->id }}">{{ $cat->category_name }}</a>
                                </td>
                                <td style="position: relative;">
                                    <label>{{ $helperController::getParentCaricatureCatName($cat->parent_category_id, true) }}</label>
                                </td>
                                <td>{{ $cat->id_name }}</td>
                                <td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                            <a class="dropdown-item" href="edit_cari_cat/{{ $cat->id }}"><i
                                                    class="dw dw-edit2"></i> Edit</a>
                                            @if ($roleManager::isAdminOrSeoManager(Auth::user()->user_type))
                                            <a class="dropdown-item"
                                               href="delete_cari_cat/{{ $cat->id }}"><i
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="delete_cat/{{ $cat->id }}"><button
...
<script>
    ...
    function imp_click($id) {
        ...
        formData.append('isCaricature', '1');
        $.ajax({
            url: url,
            type: 'POST',
            data: formData,
    ...
    function noindex_click(parentElement, $id) {
        ...
        var formData = new FormData();
        formData.append('id', $id);
        formData.append('type', 'caricature_cat');
        $.ajax({
            url: url,
            type: 'POST',
            data: formData,
