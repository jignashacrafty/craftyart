                     ...
                     <div class="row justify-content-between">
                         <div class="col-md-3 m-1">
                             @if ($roleManager::onlySeoAccess(Auth::user()->user_type) && !$roleManager::isSeoManager(Auth::user()->user_type))
                                 <a class="btn btn-primary item-form-input" href="create_virtual_cat" role="button"> Add
                                     New
                                     Category </a>
                             @endif
                         </div>
                                             ...
                                             <div class="dropdown">
                                                 ...
                                                 <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                     ...
                                                     <a class="dropdown-item"
                                                         href="edit_virtual_cat/{{ $cat->id }}"><i
                                                             class="dw dw-edit2"></i>
                                                         Edit</a>
                                                     @if ($roleManager::isAdminOrSeoManager(Auth::user()->user_type))
                                                         <a class="dropdown-item"
 ...
 <script>
     ...
     function imp_click($id) {
         ...
         var status = $id;
         var url =
             "{{ route('cat.imp', ':status') }}";
         url = url.replace(":status", status);
         var formData = new FormData();
         formData.append('id', $id);
         formData.append('isVirtual', '1');
         $.ajax({
             url: url,
             type: 'POST',
             data: formData,
