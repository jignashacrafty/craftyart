...
<div class="left-side-bar">
    ...
    <div class="menu-block customscroll">
        <div class="sidebar-menu">
            <ul id="accordion-menu">
                ...
                @if ($roleManager::isAdmin(Auth::user()->user_type))
                <li>
                    <a href="{{ route('caricature_history.index') }}"
                       class="dropdown-toggle no-arrow {{ Route::currentRouteName() == 'caricature_history.index' ? 'selectSubMenu' : '' }}">
                                <span class="micon"><img
                                            src="{{ asset('assets/vendors/images/menu_icon/Notifications.svg') }}"
                                            alt=""></span><span class="mtext">Create History</span>
                    </a>
                </li>
                @endif
    ...
    'whatsapp_config.index'
        ...
        'whatsapp_config.index'
                        ...
                        {{-- 🔹 Email --}}
                        <li class="dropdown {{ in_array(Route::currentRouteName(), ['create_email_template', 'email_report.view']) ? 'show' : '' }}">
                            <a href="javascript:;" class="dropdown-toggle">Email</a>
                            <ul class="submenu" style="display: {{ in_array(Route::currentRouteName(), ['create_email_template', 'email_report.view']) ? 'block' : 'none' }};">
                                <li>
                                    <a href="{{ route('create_email_template') }}" class="{{ Route::currentRouteName() == 'create_email_template' ? 'selectSubMenu' : '' }}">Template</a>
                                </li>
                                <li>
                                    <a href="{{ route('email_report.view') }}" class="{{ Route::currentRouteName() == 'email_report.view' ? 'selectSubMenu' : '' }}">Campaign</a>
                                </li>
                            </ul>
                        </li>

                        {{-- 🔹 WhatsApp --}}
                        <li class="dropdown {{ Route::currentRouteName() == 'whatsapp_config.index' ? 'show' : '' }}">
                            <a href="javascript:;" class="dropdown-toggle">WhatsApp</a>
                            <ul class="submenu" style="display: {{ Route::currentRouteName() == 'whatsapp_config.index' ? 'block' : 'none' }};">
                                <li>
                                    <a href="{{ route('whatsapp_config.index') }}" class="{{ Route::currentRouteName() == 'whatsapp_config.index' ? 'selectSubMenu' : '' }}">Template</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        {{-- 🔹 Automation --}}
                        <li>
                            <a href="{{ route('automation_config.index') }}" class="{{ Route::currentRouteName() == 'automation_config.index' ? 'selectSubMenu' : '' }}">Automation</a>
                        </li>
                ...
                <li>
                    <a href="{{ route('order_user.index') }}"
                       class="dropdown-toggle no-arrow {{ Route::currentRouteName() == 'order_user.index' ? 'selectSubMenu' : '' }}">
                                <span class="micon"><img
                                            src="{{ asset('assets/vendors/images/menu_icon/Notifications.svg') }}"
                                            alt=""></span><span class="mtext">Order User</span>
                    </a>
                </li>
                <li>
