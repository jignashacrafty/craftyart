...
Route::get('/test-broadcast', function () {
    event(new App\Events\PrivateUserEvent(1, 'Test broadcast message', ['test' => true]));
...
Route::get('show_employee', [EmployeeController::class, 'show'])->name('show_employee')->middleware(IsAdminOrManager::class);
