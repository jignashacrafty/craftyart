        ...
        <div class="categories-card">
            <div class="categories-header">
                <div class="row align-items-center mb-3">
                    <div class="col-md-6">
                        <h4 class="mb-0" style="font-weight: 600; color: #212529;">Template Categories</h4>
                        <p class="text-muted mb-0" style="font-size: 14px;">Manage your template category structure</p>
                    </div>
                    <div class="col-md-6 text-right">
                        @if ($roleManager::isAdminOrSeoManager(Auth::user()->user_type) || $roleManager::isSeoExecutive(Auth::user()->user_type))
                            <a class="btn btn-add-new" href="create_new_cat" role="button">
                    ...
                    <tbody>
                        @forelse ($catArray as $cat)
                            <tr>
                                ...
                                <td>{{ $helperController::getParentNewCatName($cat->parent_category_id, true) }}</td>
                                    ...
                                    <div class="dropdown action-dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                            <Button class="dropdown-item"
                                                ...
                                                Notification</Button>
                                            <a class="dropdown-item" href="edit_new_cat/{{ $cat->id }}"><i
                                                    class="dw dw-edit2"></i> Edit</a>
                                            @if ($roleManager::isAdminOrSeoManager(Auth::user()->user_type))
                                                <a class="dropdown-item"
                                                    href="delete_new_cat/{{ $cat->id }}"><i
                        ...
                        @empty
                            <tr>
                                <td colspan="13" style="text-align: center; padding: 40px; color: #6c757d;">
                                    ...
                                    <p class="mb-0">No template categories found</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
